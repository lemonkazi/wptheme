...
<div class="<?php echo apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $css_class, $this->settings['base']) ?>">
    <div class="wpb_wrapper">
        ...
        <div id="<?php echo $carousel_id ?>" data-ride="vc-carousel" data-wrap="<?php echo $wrap==='yes' ? 'true' : 'false' ?>" data-interval="<?php echo $autoplay == 'yes' ? $speed : 0 ?>" data-auto-height="true" data-mode="<?php echo $mode ?>" data-partial="<?php echo $partial_view === 'yes' ? 'true' : 'false' ?>" data-per-view="<?php echo $slides_per_view ?>" data-hide-on-end="<?php echo $autoplay == 'yes' ? 'false' : 'true' ?>" class="vc-carousel vc-slide">
            ...
            <!-- Indicators -->
            <ol class="vc-carousel-indicators <?php echo $as_color ?>">
            ...
            <div class="vc-carousel-inner">
                ...
                $block_style = isset($post->bgcolor) ? ' style="background-color: '.$post->bgcolor.'"' : '';
                    ?>
                <div class="vc-item vc_slide_<?php echo $post->post_type ?> <?php echo $as_color ?>"<?php echo $block_style ?>>
                    <div class="vc-inner">
            ...
            <!-- Controls -->
            <div class="<?php echo $as_color ?>">
            <a class="vc-left vc-carousel-control" style="z-index:9999;" href="#<?php echo $carousel_id ?>" data-slide="prev">
                <i class="icon-chevron-left"></i>
            </a>
            <a class="vc-right vc-carousel-control" style="z-index:9999;" href="#<?php echo $carousel_id ?>" data-slide="next">
                <i class="icon-chevron-right"></i>
            </a>
            </div>
         <!--   <a class="flex-next" href="#"><i class="icon-chevron-right"></i></a>-->
