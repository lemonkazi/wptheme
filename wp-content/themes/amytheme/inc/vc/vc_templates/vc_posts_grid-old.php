        ...
        <div class="teaser_grid_container">
            ...
            <ul class="wpb_thumbnails wpb_thumbnails-fluid clearfix" data-layout-mode="<?php echo $grid_layout_mode ?>">
                ...
                <?php
                    ...
                    ?>
                <div class="isotope-item <?php echo apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $li_span_class, 'vc_teaser_grid_li').$post->categories_css ?>"<?php echo $block_style ?>>
                    <?php foreach($blocks_to_build as $block_data): ?>
                    <div class="grid <?php echo $post->color;?>">
                        <?php include $this->getBlockTemplate() ?>
                    </div>
                    <?php endforeach; ?>
                </div> <?php echo $this->endBlockComment('single teaser'); ?>
                <?php endforeach; ?>
                <?php else: ?>
