...
vc_map( array(
  ...
  "params" => array(
    ...
    array(
	  ...
	  array(
      "type" => "dropdown",
      "heading" => __('Row width', 'wpb'),
      "param_name" => "full_width",
      "value" => array(
                        __("Default", 'wpb') => 'fullwidthrow',
                        __("100%", 'wpb') => 'nowidthrow'
                      ),
      "description" => __("Select row width boxed or 100%", "wpb")
    ),
    array(
      "type" => "dropdown",
  ...
  "params" => array(
    array(
	 ...
	 array(
	  ...
	  __("h3", "js_composer") => "3",
	  __("h4", "js_composer") => "4"),
      "description" => __("Select heading", "js_composer")
    ),
	 array(
      "type" => "dropdown",
      "heading" => __("Heading background", "js_composer"),
      "param_name" => "headingbg",
      "value" => array(
	  __("No", "js_composer") => "no",
	  __("Yes", "js_composer") => "yes"),
      "description" => __("Select heading background", "js_composer")
    ),
    array(
      "type" => "dropdown",
...
vc_map( array(
  ...
  "params" => array(
	...
	array(
      ...
      "param_name" => "bg_color",
      "value" => array(
	  __("Default", "js_composer") => "nocolor", 
	  __("Turquoise", "js_composer") => "turquoise", 
	  __("Greensea", "js_composer") => "greensea", 
	  __("Emerald", "js_composer") => "emerald", 
	  __("Nephritis", "js_composer") => "nephritis",
	  __("Peter river", "js_composer") => "peterriver",
	  __("Belize hole", "js_composer") => "belizehole",
	  ...
	  __("Wetasphalt", "js_composer") => "wetasphalt",
	  __("Midnightblue", "js_composer") => "midnightblue",
	  __("Concrete", "js_composer") => "concrete",
	  __("Asbestos", "js_composer") => "asbestos"),
      "description" => __("Select bacground color.", "js_composer")
    ),
    array(
      "type" => "dropdown",
      "heading" => __("Style", "js_composer"),
...
vc_map( array(
  ...
  "params" => array(
	...
	array(
	  ...
	  __("Concrete", "js_composer") => "concrete",
	  __("Asbestos", "js_composer") => "asbestos"),
      "description" => __("Select color.", "js_composer")
    ),
    $add_css_animation,
    array(
      "type" => "textfield",
...
vc_map( array(
  ...
  "params" => array(
	...
	array(
      "type" => "dropdown",
      "heading" => __("Image color", "js_composer"),
...
vc_map( array(
  ...
  "params" => array(
	...
	array(
      "type" => "dropdown",
      "heading" => __("Tab color", "js_composer"),
	  ...
	  __("Concrete", "js_composer") => "concrete",
	  __("Asbestos", "js_composer") => "asbestos"),
      "description" => __("Select tab color.", "js_composer")
    ),
...
vc_map( array(
  ...
  "params" => array(
	...
	array(
      "type" => "dropdown",
      "heading" => __("Tab body color", "js_composer"),
	  ...
	  __("Concrete", "js_composer") => "concrete",
	  __("Asbestos", "js_composer") => "asbestos"),
      "description" => __("Select tab body color.", "js_composer")
    ),
    array(
      "type" => "tab_id",
...
vc_map( array(
    "name" => __("AMY Portfolio slider/grid", "js_composer"),
    "base" => "vc_posts_grid",
    "icon" => "icon-wpb-application-icon-large",
	...
	*/
	...
	array(
      ...
      "param_name" => "grid_style",
      "value" => array(
	  __("Grid style", "js_composer") => "gridstyle", 
	  __("Slider style", "js_composer") => "sliderstyle"),
      "description" => __("Select posts style.", "js_composer")
    ),
	...
	array(
      ...
      "param_name" => "as_height",
      "description" => __("You can use px, em, etc. or enter just number and it will use pixels. ", "wpb"),
      "edit_field_class" => 'col-md-6',
	   "dependency" => Array('element' => "grid_style", 'value' => 'sliderstyle', 'callback' => 'wpb_single_image_img_link_dependency_callback')
    ),
	...
	array(
      ...
      "param_name" => "as_style",
      "value" => array(
	  __("Circle", "js_composer") => "classictilt", 
	  __("Cube", "js_composer") => "cube", 
	  __("Carousel", "js_composer") => "carousel", 
	  __("Concave", "js_composer") => "concave", 
	  __("Coverflow", "js_composer") => "coverflow",
	  __("Spiral top", "js_composer") => "spiraltop",
	  __("Spiral bottom", "js_composer") => "spiralbottom",
      ...
      "param_name" => "as_color",
      "value" => array(
	  __("White", "js_composer") => "", 
	  __("Black", "js_composer") => "as_black_style"),
      "description" => __("Select bar background color.", "js_composer"),
      "admin_label" => true
    ),
	array(
      "type" => "dropdown",
      "heading" => __("WooCommerce Style", "js_composer"),
      "param_name" => "as_woo_style",
      "value" => array(
	  __("Style 1", "js_composer") => "style1", 
	  __("Style 2", "js_composer") => "style2"),
      "description" => __("Select tile style (only for WooCommerce", "js_composer"),
      "admin_label" => true
    ),
	array(
      "type" => "dropdown",
      "heading" => __("Hover fx", "js_composer"),
      "param_name" => "as_hoverfx",
      "value" => array(
	  __("Triangle", "js_composer") => "triangle", 
	  __("Squares", "js_composer") => "squares",
	  __("Wave", "js_composer") => "wave"
	  ),
      "description" => __("Select svg hover style.", "js_composer"),
      "admin_label" => true
    ),
	...
	array(
      ...
      "param_name" => "as_thumbsize",
      "description" => __("Larger thumb size", "js_composer"),
      "value" => Array(__("Yes, please", "js_composer") => 'yes'),
	   "dependency" => Array('element' => "grid_style", 'value' => 'sliderstyle' )
    ),
	array(
      "type" => 'checkbox',
      "heading" => __("Mouse parallax", "js_composer"),
      "param_name" => "as_mouse_parallax",
	...
	array(
            ...
            "param_name" => "as_mouse_parallax_depth",
            "value" => "1.5",
            "description" => __("From 0.1 to 8", "js_composer"),
			 "dependency" => Array('element' => "grid_style", 'value' => 'sliderstyle' )
        ),
	...
	array(
	 ...
	 array(
            ...
            "param_name" => "as_first_slide",
            "value" => "0",
            "description" => __("Select which slide to be on focus when page is loaded(number).", "js_composer"),
			 "dependency" => Array('element' => "grid_style", 'value' => 'sliderstyle'),
        ),
        ...
        array(
            ...
            "admin_label" => true,
            "description" => __("Select columns count.", "js_composer"),
			  "dependency" => Array('element' => "grid_style", 'value' => 'gridstyle', 'callback' => 'wpb_single_image_img_link_dependency_callback')
        ),
       /* array(
            "type" => "sorted_list",
