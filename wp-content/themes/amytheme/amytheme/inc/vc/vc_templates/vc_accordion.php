...
$output = $title = $interval = $el_class = $add_color = $collapsible = $active_tab = '';
//
...
$output .= "\n\t".'<div class="'.$add_color.' '.$css_class.'" data-collapsible='.$collapsible.' data-active-tab="'.$active_tab.'">'; //data-interval="'.$interval.'"
