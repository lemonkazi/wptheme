...
jQuery( document ).ready(
    function() {
        ...
        jQuery( ".redux-opts-upload-scheme" ).click(
            function( event ) {
                            ...
                            jQuery.ajax(
                                {
                                    ...
                                    success: function( results ) {
                                        ...
                                        jQuery( "#sf_cardinal_options-colour_scheme_select_scheme" ).change(
                                            function( event ) {
        ...
        jQuery( "a.save-this-scheme" ).click(
            function( event ) {
        ...
        jQuery( "a.use-this-scheme" ).click(
            function( event ) {
        ...
        jQuery( "a.delete-this-scheme" ).click(
            function( event ) {
