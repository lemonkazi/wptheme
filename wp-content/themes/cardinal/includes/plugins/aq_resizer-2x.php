<?php
    function sf_aq_resize( $url, $width, $height = null, $crop = null, $single = true ) {
        ...
        if ( $width >= $orig_w ) {
            ...
            if ( $debug_mode ) {
                echo 'orig size is smaller' . "\n";
            }

            if ( ! $dst_h ) : //can't resize, so return original url
            {
                if ( $debug_mode ) {
                    echo 'cant resize' . "\n";
                }
                ...
                $dst_w   = $orig_w;
                $dst_h   = $orig_h;
            } else : //else check if cache exists
            {
