            ...
            public function install_plugins_page() {
                ...
                <div class="tgmpa wrap">
                    ...
                    <?php if ( isset( $this->message ) ) {
                        _e( wp_kses_post( $this->message ), 'swift-framework-admin' );
                    } ?>

                    <div class="sf-plugin-note-wrap clearfix">
                        <h3>Please Read!</h3>

                        <p>The plugins below are plugins that we either provide as premium plugins that are bundled with
                            the theme, or plugins that we recommend in order to take advantage of theme
                            functionality.</p>

                        <p>In all cases if you don't need a certain plugin, or aren't sure, then please do not
                            install/activate them - until you decide they are needed. Installing more plugins than you
                            need will likely slow your site down. For example, unless you really need to, then we'd
                            recommend only installing one or two (maximum) of the slider plugins.</p>

                        <p>Once you've installed a plugin, you'll need to also click the "Activate" link, and then
                            reload the browser to see the plugin's menu.</p>
                    </div>
