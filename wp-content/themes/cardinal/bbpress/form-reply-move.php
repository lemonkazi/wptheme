...
<div id="bbpress-forums">
                    ...
                    <div>
                        ...
                        <fieldset class="bbp-form">
                            ...
                            <div>
                                ...
                                <label
                                    for="bbp_reply_move_option_reply"><?php printf( __( 'New topic in <strong>%s</strong> titled:', 'bbpress' ), bbp_get_forum_title( bbp_get_reply_forum_id( bbp_get_reply_id() ) ) ); ?></label>
                            ...
                            <?php if ( bbp_has_topics( array(
                                ...
                                <div>
                                    ...
                                    <label
                                        for="bbp_reply_move_option_existing"><?php _e( 'Use an existing topic in this forum:', 'bbpress' ); ?></label>
    ...
    <?php else : ?>
        ...
        <div id="no-reply-<?php bbp_reply_id(); ?>" class="bbp-no-reply">
            <div
                class="entry-content"><?php is_user_logged_in() ? _e( 'You do not have the permissions to edit this reply!', 'bbpress' ) : _e( 'You cannot edit this reply.', 'bbpress' ); ?></div>
        </div>
