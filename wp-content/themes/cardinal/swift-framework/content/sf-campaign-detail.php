    ...
    */
            ...
            <div class="campaign-detail row">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="campaign-meta">
                        <time class="date" datetime="<?php echo $post_date_str; ?>">
                            <span><?php _e( 'Launched', 'swiftframework' ); ?></span><?php echo $post_date; ?></time>
                        <?php if ( ! $campaign->is_endless() ) { ?>
                            <div class="funding-ends">
                                <span><?php _e( 'Funding Ends', 'swiftframework' ); ?></span><?php echo $end_date ?>
                            </div>
                        <?php } ?>
                        <?php if ( $campaign->location() ) : ?>
                            <div class="location">
                                <span><?php _e( 'Location', 'swiftframework' ); ?></span><?php echo $campaign->location(); ?>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    if ( ! function_exists( 'sf_campaign_sidebar' ) ) {
        function sf_campaign_sidebar() {
            ...
            ?>
            <div id="back-this-project" class="campaign-sidebar <?php echo $extra_class; ?> col-sm-4">
                <?php
            ...
            <div class="author-info-wrap clearfix">
                ...
                <div class="author-bio">
                    ...
                    <?php if ( $campaign->contact_email() != "" ) { ?>
                        <a href="mailto:<?php echo $campaign->contact_email(); ?>"
            ...
            <div class="campaign-info post-info clearfix">
                ...
                <div class="comments-likes">
                    <?php if ( comments_open() ) { ?>
                        <div class="comments-wrapper"><a href="#comments" class="smooth-scroll-link"><i
                                    class="ss-chat"></i><span><?php comments_number( __( '0 Comments', 'swiftframework' ), __( '1 Comment', 'swiftframework' ), __( '% Comments', 'swiftframework' ) ); ?></span></a>
                        </div>
                    <?php } ?>
                            ...
                            <?php foreach ( $backers as $backer ) : ?>
                                ...
                                <li class="backer">
                                    ...
                                    <div class="backer-info">
                                        ...
                                        <?php } else { ?>
                                            <strong><?php echo $user_info['first_name']; ?> <?php echo $user_info['last_name']; ?></strong>
                                            <br/>
                                        <?php } ?>
