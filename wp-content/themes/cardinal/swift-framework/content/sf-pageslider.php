    ...
    if ( ! function_exists( 'sf_pageslider' ) ) {
        function sf_pageslider() {
            ...
            <?php if ( $page_slider == "swift-slider" ) { ?>
                ...
                <?php echo do_shortcode( '[swift_slider type="' . $ss_type . '" category="' . $ss_category . '" fullscreen="' . $ss_fs . '" max_height="' . $ss_maxheight . '" slide_count="' . $ss_slidecount . '" loop="' . $ss_loop . '" nav="' . $ss_nav . '" pagination="' . $ss_pagination . '" autoplay="' . $ss_autoplay . '" continue="' . $ss_continue . '"]' ); ?>
