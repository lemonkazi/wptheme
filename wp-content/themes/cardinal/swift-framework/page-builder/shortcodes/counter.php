    ...
    */
    ...
    SPBMap::map( 'spb_counter', array(
        ...
        "params" => array(
            ...
            array(
                "type"        => "textfield",
                "heading"     => __( "Counter Prefix", "swift-framework-admin" ),
                "param_name"  => "prefix",
                "value"       => "",
                "description" => __( "Enter the text which you would like to show before the count number (optional).", "swift-framework-admin" )
            ),
            array(
                "type"        => "textfield",
                "heading"     => __( "Counter Suffix", "swift-framework-admin" ),
                "param_name"  => "suffix",
                "value"       => "",
                "description" => __( "Enter the text which you would like to show after the count number (optional).", "swift-framework-admin" )
            ),
            array(
                "type"        => "dropdown",
                "heading"     => __( "Counter Commas", "swift-framework-admin" ),
                "param_name"  => "commas",
                "value"       => array(
                    "Yes" => "true",
                    "No"  => "false",
                ),
                "description" => __( "Include comma separators in the numbers after every 3rd digit.", "swift-framework-admin" )
            ),
            array(
                "type"        => "dropdown",
