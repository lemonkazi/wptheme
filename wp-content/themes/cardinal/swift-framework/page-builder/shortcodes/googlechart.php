    ...
    SPBMap::map( 'spb_googlechart', array(
        ...
        "params" => array(
            ...
            array(
                ...
                "param_name"  => "type",
                "value"       => array(
                    __( 'Line', "swift-framework-admin" )    => "line",
                    __( 'Pie', "swift-framework-admin" )     => "pie",
                    __( 'Pie 2D', "swift-framework-admin" )  => "pie2d",
                    __( 'XY Line', "swift-framework-admin" ) => "xyline",
                    __( 'Scatter', "swift-framework-admin" ) => "scatter"
                ),
