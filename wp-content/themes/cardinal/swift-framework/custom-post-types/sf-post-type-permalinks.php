    ...
    if ( ! class_exists( 'sf_post_type_permalinks' ) ) :
        ...
        class sf_post_type_permalinks {
            ...
            public function settings_init() {
                ...
                add_settings_section( 'sf-galleries-permalink', __( 'Galleries permalink base', 'swift-framework-admin' ), array(
                        $this,
                        'galleries_settings'
                    ), 'permalink' );

                // Add galleries settings
                add_settings_field( 'galleries_category_slug', __( 'Galleries category base', 'swift-framework-admin' ), array(
                        $this,
                ...
                // Add team section to the permalinks page
                add_settings_section( 'sf-directory-permalink', __( 'Directory permalink base', 'swift-framework-admin' ), array(
                        $this,
                        'directory_settings'
                    ), 'permalink' );

                // Add team settings
                add_settings_field( 'directory_category_slug', __( 'Directory category base', 'swift-framework-admin' ), array(
                        $this,
                        'directory_category_slug_input'
                    ), 'permalink', 'optional' );

                // Add team settings
                add_settings_field( 'directory_location_slug', __( 'Directory location base', 'swift-framework-admin' ), array(
                        $this,
            ...
            public function directory_category_slug_input() {
                ...
                <input name="directory_category_slug" type="text" class="regular-text code"
                       ...
                       } ?>" placeholder="<?php echo __( 'directory-category', 'swift-framework-admin' ) ?>"/>
            <?php
            }
            ...
            public function directory_location_slug_input() {
                ...
                <input name="directory_location_slug" type="text" class="regular-text code"
                       ...
                       } ?>" placeholder="<?php echo __( 'directory-location', 'swift-framework-admin' ) ?>"/>
            <?php
            }
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th><label><input name="galleries_permalink" type="radio" value="<?php echo $structures[0]; ?>"
                                          class="sf_gal_tog" <?php checked( $structures[0], $galleries_permalink ); ?> /> <?php _e( 'Default', 'swift-framework-admin' ); ?>
                            </label></th>
                    ...
                    <tr>
                        <th><label><input name="galleries_permalink" type="radio" value="<?php echo $structures[1]; ?>"
                                          class="sf_gal_tog" <?php checked( $structures[1], $galleries_permalink ); ?> /> <?php _e( 'Galleries', 'swift-framework-admin' ); ?>
                            </label></th>
            ...
            public function directory_settings() {
                echo wpautop( __( 'These settings control the permalinks used for directory items. These settings only apply when <strong>not using "default" permalinks above</strong>.', 'swift-framework-admin' ) );
                ...
                $base_slug      = __( 'directory', 'swift-framework-admin' );
                $directory_base = __( 'directory', 'swift-framework-admin' );
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th><label><input name="directory_permalink" type="radio" value="<?php echo $structures[0]; ?>"
                                          class="sf_directory_tog" <?php checked( $structures[0], $directory_permalink ); ?> /> <?php _e( 'Default', 'swift-framework-admin' ); ?>
                            </label></th>
                    ...
                    <tr>
                        <th><label><input name="directory_permalink" type="radio" value="<?php echo $structures[1]; ?>"
                                          class="sf_directory_tog" <?php checked( $structures[1], $directory_permalink ); ?> /> <?php _e( 'Directory', 'swift-framework-admin' ); ?>
                            </label></th>
