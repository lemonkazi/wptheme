        ...
        <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
            ...
            <div class="sf-menu-options">
                ...
                <?php if ( $depth == 0 ) { ?>
                    ...
                    <p class="field-custom description description-wide">
                        <label
                            for="edit-menu-megamenu-<?php echo $item_id; ?>"><?php _e( 'Enable Mega Menu', 'swift-framework-admin' ); ?>
                    ...
                    <p class="field-custom description description-wide">
                        <label
                            for="edit-menu-megamenucols-<?php echo $item_id; ?>"><?php _e( 'Mega Menu Columns', 'swift-framework-admin' ); ?></label>
                    ...
                    <p class="field-custom description description-wide">
                        <label
                            for="edit-menu-is-naturalwidth-<?php echo $item_id; ?>"><?php _e( 'Natural Width Mega Menu', 'swift-framework-admin' ); ?>
                    ...
                    <p class="field-custom description description-wide">
                        <label
                            for="edit-menu-is-altstyle-<?php echo $item_id; ?>"><?php _e( 'Alternative Style Mega Menu', 'swift-framework-admin' ); ?>
                    ...
                    <p class="field-custom description description-wide">
                        <label
                            for="edit-menu-hideheadings-<?php echo $item_id; ?>"><?php _e( 'Hide Mega Menu Headings', 'swift-framework-admin' ); ?>
                ...
                <p class="field-custom description description-thin"
                   style="height: auto;overflow: hidden;width: 50%;float: none;">
                    <label
                        for="edit-menu-item-icon-<?php echo $item_id; ?>"><?php _e( 'Menu Icon (Gizmo / Font Awesome)', 'swift-framework-admin' ); ?>
                ...
                <?php if ( $depth == 1 ) { ?>
                    ...
                    <p class="field-custom description description-wide">
                        <label
                            for="edit-menu-megatitle-<?php echo $item_id; ?>"><?php _e( 'Mega Menu No Link Title', 'swift-framework-admin' ); ?>
                    ...
                    <p class="field-custom description description-wide">
                        <label
                            for="edit-menu-nocolumnspacing-<?php echo $item_id; ?>"><?php _e( 'No Menu Column Spacing (for custom html column)', 'swift-framework-admin' ); ?>
                    ...
                    <p class="field-custom description description-wide">
                        <label
                            for="edit-menu-item-icon-<?php echo $item_id; ?>"><?php _e( 'Custom HTML Column Width (optional)', 'swift-framework-admin' ); ?>
                    ...
                    <p class="field-custom description description-wide">
                        <label
                            for="edit-menu-item-htmlcontent-<?php echo $item_id; ?>"><?php _e( 'Custom HTML Column (within Mega Menu)', 'swift-framework-admin' ); ?>
